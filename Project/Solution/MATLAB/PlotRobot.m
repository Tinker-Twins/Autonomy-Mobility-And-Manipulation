function PlotRobot(states, params)
    %{
    ...
    fill(m_x,m_y,'black','FaceAlpha',0.3);
    hold on
    fill(w_r_x,w_r_y,'black');
    fill(w_l_x,w_l_y,'black');
    plot(l1_x,l1_y,'.-black','LineWidth',2.5,'MarkerSize',25);
    plot(l2_x,l2_y,'black','LineWidth',2.5);
